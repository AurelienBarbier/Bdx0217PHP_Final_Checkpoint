...
use MarmiwildBundle\Entity\Ingredient;
...
class IngredientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ingredients = $em->getRepository('MarmiwildBundle:Ingredient')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MarmiwildBundle\Form\IngredientType', $ingredient);
    ...
    {
        $deleteForm = $this->createDeleteForm($ingredient);
        $editForm = $this->createForm('MarmiwildBundle\Form\IngredientType', $ingredient);
