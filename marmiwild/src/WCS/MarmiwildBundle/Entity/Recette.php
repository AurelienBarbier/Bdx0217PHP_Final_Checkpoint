...
namespace WCS\MarmiwildBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="WCS\MarmiwildBundle\Repository\RecetteRepository")
 *
 */
class Recette
{
     ...
     * @var string
     *
     * @ORM\Column(name="personne", type="decimal", precision=10, scale=0)
     */
    private $personne;
