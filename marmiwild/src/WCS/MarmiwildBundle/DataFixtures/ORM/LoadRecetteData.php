...
class LoadRecetteData implements FixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $tab = array(
            array('nom'=>'Brownies',
                'type'=>'Desserts',
                'imageFile' =>'assets/img/photos/brownies.jpg',
                'personne'=>6,
            ...
            array('nom' =>'Poulet Basquaise',
                'type'=>'Plats',
                'imageFile' =>'assets/img/photos/poulet_basquaise.jpg',
                'personne'=>4,
            ...
            array('nom'=>'Oeufs d\'Oie en Salade',
                'type'=>'Entrees',
                'imageFile' =>'assets/img/photos/salade.jpg',
                'personne'=>4,
            ...
            array('nom'=>'Crêpes au cidre',
                'type'=>'Entrees',
                'imageFile' =>'assets/img/photos/crepes.jpg',
                'personne'=>4,
