...
use Marmi\MarmiBundle\Entity\Recipe;
...
class RecipeController extends Controller
{
    ...
    {
        $recipe = new Recipe();
        $form = $this->createForm('Marmi\MarmiBundle\Form\RecipeType', $recipe);
    ...
    {
        $deleteForm = $this->createDeleteForm($recipe);
        $editForm = $this->createForm('Marmi\MarmiBundle\Form\RecipeType', $recipe);
