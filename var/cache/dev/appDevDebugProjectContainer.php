...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->normalizedIds = array(
            'cuisinons.fileuploadlistener' => 'cuisinons.FileUploadListener',
        );
        $this->methodMap = array(
            '1_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9' => 'get1Bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9Service',
            '2_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9' => 'get2Bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9Service',
            ...
            'cuisinons.FileUploadListener' => 'getCuisinons_FileUploadListenerService',
            'cuisinons.upload' => 'getCuisinons_UploadService',
        ...
        $this->privates = array(
            '1_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9' => true,
            '2_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9']) ? $this->services['1_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9'] : $this->get1Bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9']) ? $this->services['2_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9'] : $this->get2Bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9Service()) && false ?: '_'};
        }, 2));
    }
    ...
    /**
     * Gets the 'cuisinons.FileUploadListener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CuisinonsBundle\EventListener\RecetteUploadListener A CuisinonsBundle\EventListener\RecetteUploadListener instance
     */
    protected function getCuisinons_FileUploadListenerService()
    {
        return $this->services['cuisinons.FileUploadListener'] = new \CuisinonsBundle\EventListener\RecetteUploadListener(${($_ = isset($this->services['cuisinons.upload']) ? $this->services['cuisinons.upload'] : $this->get('cuisinons.upload')) && false ?: '_'});
    }

    /**
     * Gets the 'cuisinons.upload' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CuisinonsBundle\Service\FileUploader A CuisinonsBundle\Service\FileUploader instance
     */
    protected function getCuisinons_UploadService()
    {
        return $this->services['cuisinons.upload'] = new \CuisinonsBundle\Service\FileUploader(($this->targetDirs[3].'/web/uploads'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), ${($_ = isset($this->services['cuisinons.FileUploadListener']) ? $this->services['cuisinons.FileUploadListener'] : $this->get('cuisinons.FileUploadListener')) && false ?: '_'});

        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'cuisinons', 'user' => 'root', 'password' => 'mysqlr@@t', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/CuisinonsBundle/Entity'))), 'CuisinonsBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CuisinonsBundle' => 'CuisinonsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_aa78aa7fbb954759022475a48e347d67f7e56468c289442f8e84ded8427148b4');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('CuisinonsBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n->setOptions(array('login_path' => 'cuisinons_login', 'default_target_path' => 'cuisinons_homepage', 'always_use_default_target_path' => true, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $o->setOptions(array('login_path' => 'cuisinons_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $p = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $l, 'cuisinons_login', false);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.our_db_provider']) ? $this->services['security.user.provider.concrete.our_db_provider'] : $this->getSecurity_User_Provider_Concrete_OurDbProviderService()) && false ?: '_'}, 1 => new \Symfony\Component\Security\Core\User\InMemoryUserProvider()), 'main', $a, $c, $d), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $l, 'main', $n, $o, array('check_path' => 'cuisinons_login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $g, 'main', $p, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '596642aacd2857.16262938', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $k, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $l, 'main', $p, NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.our_db_provider', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'http_basic', 3 => 'anonymous')));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CuisinonsBundle/Resources/views'), 'Cuisinons');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6f41c6f81229e23c67d0d30051073a92b8760020');
    }
    ...
    /**
     * Gets the '1_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get1Bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9Service()
    {
        return $this->services['1_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get2Bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9Service()
    {
        return $this->services['2_bdd378428d1c17fb1672303b05db7ac0e2ac43bf505da55b75ab9f698e6ca2f9'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('SQtbb8LG4o', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4tdFW0HE7A', 0, '825gB9GNFNo2P5uMysa0yK', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QslvALS-kH', 0, '825gB9GNFNo2P5uMysa0yK', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rvEzpE3uVH', 0, '825gB9GNFNo2P5uMysa0yK', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('596642aacd2857.16262938');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.our_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->get('doctrine')) && false ?: '_'}, 'CuisinonsBundle:User', 'username', NULL);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'CuisinonsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CuisinonsBundle'),
                    'namespace' => 'CuisinonsBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            case 'recette_directory': $value = ($this->targetDirs[3].'/web/uploads'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CuisinonsBundle' => 'CuisinonsBundle\\CuisinonsBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'cuisinons',
            'database_user' => 'root',
            'database_password' => 'mysqlr@@t',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '6f41c6f81229e23c67d0d30051073a92b8760020',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '6f41c6f81229e23c67d0d30051073a92b8760020',
