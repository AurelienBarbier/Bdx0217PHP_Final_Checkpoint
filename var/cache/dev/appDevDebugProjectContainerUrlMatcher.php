...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ('' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'cuisinons_homepage');
            }

            return array (  '_controller' => 'CuisinonsBundle\\Controller\\DefaultController::indexAction',  '_route' => 'cuisinons_homepage',);
        }

        // cuisinons_login
        if ('/login' === $pathinfo) {
            return array (  '_controller' => 'CuisinonsBundle\\Controller\\DefaultController::loginAction',  '_route' => 'cuisinons_login',);
        }
